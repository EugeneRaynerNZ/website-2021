        ...
        <div class="project" v-for="project in projects" :key="'v-' + project.name">
            ...
            <div class="content">
                <div class="creative">
                    ...
                    <router-link :to="project.routerLink" class="main-button">
          ...
          projects: [
            {
                ...
                routerLink: '/creations/email-development/air-new-zealand',
                creative: [
            ...
            },
            {
                ...
                imageUrl: Vodafone,
                routerLink: '/creations/email-development/vodafone',
                creative: [
            ...
            },
            {
                name: 'Westpac',
                imageUrl: Westpac,
                routerLink: '/creations/email-development/westpac',
                creative: [
