<template>
    <div id="project" class="projectContent--mobile">
      ...
      <header class="projectHeader projectHeaderBoysNight">
        <img :src="boysNightLanding" />
        <!-- <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="393" height="873" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FT9Rfeh6cCidjQpFoAActWy%2FFreejoas%3Fpage-id%3D3%253A3%26node-id%3D701-212%26viewport%3D-7669%252C-5021%252C0.25%26t%3DdwHJHjwQdrxFjgbW-1%26scaling%3Dmin-zoom%26starting-point-node-id%3D701%253A212" allowfullscreen></iframe> -->
      </header>
  ...
  <script>
  import BoysNightLanding from "@/assets/boys-night/boys-night-landing.png";
  ...
  export default {
    ...
    data() {
      return {
        boysNightLanding: BoysNightLanding,
